    ...
    return (
        <div className={`font-sans ${TEXT_COLOR} ${MAIN_BG} min-h-screen`}>
            ...
            <section className="relative h-screen w-full">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/contacthero.jpg')" }}>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-6">
                    ...
                    <p className="text-lg max-w-4xl mb-12 font-medium">
                        Coming soon: you’ll be able to send us your questions, feedback, or requests directly through this page.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto text-center space-y-4">
                    ...
                    <div className="text-gray-500 text-sm">
                        ...
                        <p>
                            ...
                            <span className={`text-red-600`}>support@edustarhub.com</span>
                        </p>
                    </div>
                </div>
            </footer>
