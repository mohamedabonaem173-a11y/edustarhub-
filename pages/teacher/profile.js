...
export default function TeacherProfile() {
    const role = 'teacher'; // Set the role explicitly
        ...
        async function getProfile() {
            ...
            try {
                ...
                setProfile({
                    ...
                    role: data?.role || 'teacher', // Default to teacher if missing
                });
    ...
    return (
        <div className="min-h-screen bg-gray-50"> 
            ...
            <div className="max-w-7xl mx-auto flex pt-4"> 
                {/* Ensure the Sidebar links are correct for the teacher role */}
                <Sidebar role={role} /> 
                
                <main className="flex-1 p-8">
                    <div className="mb-8">
                        <h1 className="text-4xl font-extrabold text-gray-900">👤 My Teacher Profile</h1>
                            ...
                            <div className="bg-white rounded-xl shadow-xl p-6">
                                ...
                                <form onSubmit={handleUpdateProfile} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-lg font-semibold text-violet-600">TEACHER</p>
                                    </div>
